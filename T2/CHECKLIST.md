...
- [ ] **1.1** – Validar os 3 argumentos; se faltar, mostrar ajuda e sair.
- [ ] **1.2** – Verificar se `Tipo_Digest` é MD5, SHA1, SHA256 ou SHA512.
- [ ] **1.3** – Confirmar que `Caminho_da_Pasta` existe e é uma pasta.
